...
/**
 * Dashboard sidebar/navbar shell for routes that stay reachable without an
 * account (see PUBLIC_PATHS in middleware.ts — /distributions and
 * /projets-plantation/nouveau). Signed-in members get the normal chrome;
 * guests get the bare page, since AccountSwitcher/requireRole assume a user.
 */
export async function OptionalMemberShell({ children }: { children: ReactNode }) {
