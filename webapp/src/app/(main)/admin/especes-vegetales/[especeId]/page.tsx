...
const TaxonDetailView = dynamic(() => import("../_components/taxon-detail-view").then((m) => m.TaxonDetailView), {
  ssr: false,
});

export default function TaxonDetailPage({ params }: { params: Promise<{ especeId: string }> }) {
