/**
 * Mock fixture for the member-facing distributions pages only. Reservations
 * wiring is a separate, not-yet-scheduled task — the admin side
 * (`admin/distributions/_components/`) is wired to the real backend; this
 * file exists purely so these pages keep compiling and demoing without
 * depending on the admin collection's (now real, English-shaped) data.
 */
